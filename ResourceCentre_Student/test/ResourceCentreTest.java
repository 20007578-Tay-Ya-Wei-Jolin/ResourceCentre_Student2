...
public class ResourceCentreTest {
	...
	public void retrieveAllChromebookTest() {
		...
		testOutput = String.format("%-10s %-30s %-10s %-10s %-20d\n", "CB001", "ASUS Chromebook", "Yes", "Win10");
		testOutput += String.format("%-10s %-30s %-10s %-10s %-20d\n", "CB002", "HP Chromebook", "Yes", "Win10");
	...
	public void doReturnChromebookTest() {
		...
		assertFalse("Test if available chromebook CB001 is returned -false?", isReturned);
		// normal
		ResourceCentre.addChromebook(chromebookList, cb2);
		cb2.setIsAvailable(false);
		...
		assertFalse("Test if non-existing chromebook CB003 is returned -false?", isReturned);
	}
